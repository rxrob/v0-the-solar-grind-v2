-- Create Rob's admin account with proper security
-- First, let's make sure the users table exists and has all required columns

-- Insert or update Rob's account
INSERT INTO users (
    id,
    email,
    name,
...
-- Insert some sample projects for Rob
...
-- Insert some sample calculations for Rob
