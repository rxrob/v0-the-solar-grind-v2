...
const testimonials = [
  {
    name: "Sarah Johnson",
    role: "Homeowner",
    content: "MySolarAI helped me understand exactly how much I could save with solar. The calculations were spot-on!",
    rating: 5,
  },
  {
    name: "Mike Chen",
...
export default function HomePage() {
  ...
  const [isSignedIn, setIsSignedIn] = useState(false) // replace with Supabase auth check later
  const { scrollYProgress } = useScroll()
  const y = useTransform(scrollYProgress, [0, 1], ["0%", "50%"])
  const opacity = useTransform(scrollYProgress, [0, 0.5], [1, 0])

  useEffect(() => {
    // TODO: Check Supabase auth status here
    // setIsSignedIn(true) if user is logged in
  }, [])
    ...
    <div className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <header className="fixed top-0 left-0 w-full bg-black/80 backdrop-blur-md shadow-md z-50 px-6 py-4 flex justify-between items-center border-b border-orange-500">
        ...
        <nav className="flex gap-6 items-center text-sm font-semibold">
          <Link href="/calculator" className="hover:text-orange-400">
            Free Calculator
          </Link>
          {isSignedIn && (
          ...
          <Link href="/auth" className="bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-lg text-white transition">
      ...
      {/* Hero Section */}
      <motion.section className="relative z-10 container mx-auto px-4 pt-20 pb-32" style={{ y, opacity }}>
      ...
      <section className="mt-24 px-6 w-full flex flex-col items-center">
        {location ? (
          ...
          <p className="text-white">Locating your area...</p>
        )}
      ...
      <section className="mt-32 px-6 w-full flex flex-col items-center text-center">
        <h2 className="text-3xl font-bold text-white mb-4">Your Solar Score</h2>
        ...
        <div className="mt-8 p-5 max-w-2xl text-left bg-white/10 backdrop-blur-md rounded-xl border border-orange-400 text-gray-200 shadow-md">
          ...
          <p>
            ...
            <span className="font-semibold text-green-300">10,400 kWh/year</span>. That means you could save up to{" "}
            <span className="text-green-300 font-semibold">$1,400–$1,800 annually</span> with a properly sized system.
      ...
      {/* Background Glow */}
      <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[700px] h-[700px] bg-gradient-to-tr from-yellow-400 via-orange-500 to-red-600 opacity-30 blur-3xl rounded-full pointer-events-none z-0" />

      {/* Features Section */}
      <motion.section
        className="relative z-10 py-20 bg-white/80 backdrop-blur-sm"
        initial={{ opacity: 0 }}
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose MySolarAI?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="h-full hover:shadow-lg transition-shadow duration-300 border-0 bg-gradient-to-br from-white to-blue-50/50">
      ...
      <motion.section
        className="relative z-10 py-20 bg-gradient-to-r from-blue-50 to-green-50"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        transition={{ duration: 0.8 }}
        viewport={{ once: true }}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="relative h-full border-2 border-gray-200 hover:border-blue-300 transition-colors">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="relative h-full border-2 border-blue-500 shadow-lg scale-105">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="relative h-full border-2 border-gray-200 hover:border-green-300 transition-colors">
                <CardHeader className="text-center pb-8">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button
                    asChild
                    variant="outline"
                    className="w-full mt-8 border-green-500 text-green-600 hover:bg-green-50 bg-transparent"
                  >
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Join thousands of homeowners who've discovered their solar potential with MySolarAI. Start your free
              analysis today.
            </p>
