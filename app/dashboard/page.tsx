  ...
  return (
    <div>
      ...
      <main className="container mx-auto p-4 text-white">
        ...
        <Card className="bg-gray-800/50 border-gray-700 hover:shadow-lg hover:shadow-orange-500/10 transition-shadow mb-8">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-gray-300">Account Information</CardTitle>
            <Crown className="h-4 w-4 text-orange-400" />
          </CardHeader>
          <CardContent>
            <div className="mb-4">
              <p className="font-medium text-gray-200">
                User ID: <code className="text-sm bg-muted p-1 rounded">{user.id}</code>
              </p>
            </div>
            <BillingPortalButton />
          </CardContent>
